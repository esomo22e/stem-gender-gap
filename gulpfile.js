...
gulp.task('images', function(){
  ...
  .pipe(cache(imagemin()))
  .pipe(gulp.dest('dist/interactive/2020/02/science-gender-gap/scrolly-graph/images'))
  .pipe(browserSync.reload({
    stream: true
  }))
...
gulp.task('csvToJson', function(){
  ...
  .pipe(gulp.dest('dist/interactive/2020/02/science-gender-gap/scrolly-graph/data'))
  .pipe(browserSync.reload({
    stream: true
  }))
